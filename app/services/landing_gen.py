...
<nav style="background:#fff;border-bottom:1px solid #E2E8F0;position:sticky;top:0;z-index:100;padding:0">
  <div class="container" style="display:flex;align-items:center;justify-content:space-between;padding:14px 24px">
    <div style="display:flex;align-items:center;gap:32px">
      <a href="/landing/brands/default/index.html" style="font-size:22px;font-weight:800;color:#0F172A;text-decoration:none" data-i18n="common:brand_name">Ki<span style="color:var(--brand-dk)">X</span></a>
      <div class="nav-products" style="display:flex;gap:22px;font-size:14px;font-weight:600">
        <a href="/landing/brands/default/index.html" style="color:#475569;text-decoration:none" data-i18n="common:nav.single">Single stall</a>
        <a href="/landing/brands/kopi_king_chain/index.html" style="color:#475569;text-decoration:none" data-i18n="common:nav.chains">For chains</a>
        <a href="/landing/brands/kix_for_enterprise/index.html" style="color:#475569;text-decoration:none" data-i18n="common:nav.enterprise">Enterprise</a>
        <a href="/landing/pricing.html" style="color:#475569;text-decoration:none" data-i18n="common:nav.pricing">Pricing</a>
        <a href="/landing/brands/{_esc(cfg.brand_id)}/details.html" style="color:#475569;text-decoration:none" data-i18n="common:nav.specs">Specs</a>
      </div>
    </div>
    <div style="display:flex;align-items:center;gap:14px">
      <span class="kix-lang-slot"></span>
      <a href="{_esc(cfg.portal_link)}" style="font-size:14px;color:#475569;text-decoration:none;font-weight:600" data-i18n="common:nav.signin">Sign in</a>
      <a href="{_esc(cfg.portal_link)}?tier=free&brand={_esc(cfg.brand_id)}" style="background:#0F172A;color:#fff;padding:9px 18px;border-radius:7px;font-size:13.5px;font-weight:700;text-decoration:none" data-i18n="common:nav.start_free">Start free</a>
    </div>
  </div>
