...
# All 249 ISO 3166-1 alpha-2 codes — KiX is global Day-1
# (was 22 launch countries pre-Wave-H Opp D)
_LAUNCH_COUNTRIES = [
...
assert len(_LAUNCH_COUNTRIES) == 249, f"ISO 3166 should have 249 codes, got {len(_LAUNCH_COUNTRIES)}"
