...
REGION_CONFIG: dict[str, dict[str, Any]] = {
    ...
    "id": {
        ...
        # Phase 2 SEA: support id-ID natively, fall back to en-SG then en-US.
        "languages": ["id-ID", "en-US"],
        "supported_locales": ["id-ID", "en-US"],
        "language_fallback_chain": ["id-ID", "id", "en-SG", "en-US"],
    ...
    # ── Phase 2 SEA additions (Wave 3) ──────────────────────────────────
    "my": {
        "region_code": "my",
        "region_name": "Malaysia-KualaLumpur",
        "compliance_jurisdiction": "MY",
        "applicable_laws": ["PDPA (Malaysia, 2010)"],
        "primary_currency": "MYR",
        "supported_currencies": ["MYR", "USD"],
        "payment_methods": ["fpx", "grabpay", "boost", "credit_card"],
        "languages": ["ms-MY", "en-US"],
        "supported_locales": ["ms-MY", "en-US"],
        "language_fallback_chain": ["ms-MY", "ms", "en-SG", "en-US"],
        "default_phone_country_code": "+60",
        "redis_url": os.environ.get("REDIS_URL_MY", "redis://redis:6379/0"),
        "db_url": os.environ.get("DATABASE_URL_MY", ""),
        "data_residency_required": False,
    },
    "th": {
        "region_code": "th",
        "region_name": "Thailand-Bangkok",
        "compliance_jurisdiction": "TH",
        "applicable_laws": ["PDPA (Thailand, 2019)"],
        "primary_currency": "THB",
        "supported_currencies": ["THB", "USD"],
        "payment_methods": ["promptpay", "truemoney", "credit_card"],
        "languages": ["th-TH", "en-US"],
        "supported_locales": ["th-TH", "en-US"],
        "language_fallback_chain": ["th-TH", "th", "en-SG", "en-US"],
        "default_phone_country_code": "+66",
        "redis_url": os.environ.get("REDIS_URL_TH", "redis://redis:6379/0"),
        "db_url": os.environ.get("DATABASE_URL_TH", ""),
        "data_residency_required": False,
    },
    "vn": {
        "region_code": "vn",
        "region_name": "Vietnam-HoChiMinh",
        "compliance_jurisdiction": "VN",
        "applicable_laws": ["Personal Data Protection Decree (PDPD, 2023)"],
        "primary_currency": "VND",
        "supported_currencies": ["VND", "USD"],
        "payment_methods": ["momo", "zalopay", "vnpay", "credit_card"],
        "languages": ["vi-VN", "en-US"],
        "supported_locales": ["vi-VN", "en-US"],
        "language_fallback_chain": ["vi-VN", "vi", "en-SG", "en-US"],
        "default_phone_country_code": "+84",
        "redis_url": os.environ.get("REDIS_URL_VN", "redis://redis:6379/0"),
        "db_url": os.environ.get("DATABASE_URL_VN", ""),
        "data_residency_required": False,
    },
    "sg": {
        "region_code": "sg",
